...
public class ServletBasic extends HttpServlet {
	...
	/*	
		...
		//응답 화면 제작 
		// 자바 클래스에서 브라우져로 바로 응답을 구현하기 위해서는 
		//PrintWriter객체를 사용합니다.
		...
		w.flush(); //버퍼를 비우면서 작성한 내용을 브라우져를 밀어내는 
		w.close(); //객체 해제 
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//객체의 메서드를 통해 파라미터를  가져오거나, 페이지 이동이 가능합니더.
	...
	@Override
	public void	destroy() {
		// 서블릿 객체가 소멸될 때 호출되느 메서드 (객체 소멸시 1회 자동 호출)
